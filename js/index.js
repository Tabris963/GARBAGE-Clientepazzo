  ...
  $.ajax({
    ...
    success: function(resp){
      ...
      for (var i = 0; i < resp.products.length; i++) {
        ...
        tmp += '<a href="product-details.php?id='+resp.products[i].id+'" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Visualizza dettagli</a>';
      ...
      for (i = 0; i < resp.products; i++) {
        ...
        tmp += '<p>'+resp.products[i].nome+'</p>';
        tmp += '<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Visualizza dettagli</a></div></div></div></div>';
